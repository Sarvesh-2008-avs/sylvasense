        ...
        <aside className="panel left">
          ...
          <div className="note">
            ...
            <p>
              ...
              optical imagery and Sentinel-1
              radar screening. Individual tree counting
              is not fabricated when suitable
              high-resolution imagery and a
              trained tree detection model are
              unavailable.
            </p>
        ...
        <aside className="panel right">
          ...
          {result && (
            ...
            <>
              ...
              <div className="tree" style={{ marginBottom: '12px' }}>
                ...
                <p>
                  {treeModelStatus?.message ||
                    'YOLOv8-OBB tree detection requires a tree-trained model and high-resolution imagery.'}
                </p>
              ...
              <div className="tree">
                <span>AI-ESTIMATED TREE COUNT</span>
